/**
********************************************************************************************************************************
* @file    module_applicatin_testing.c 
* @author  Pamela Lee
* @brief   This is the module for supporting FCT, BurnIn and End-of-Line testing for the application.
* @details This application processes requests for test modes and provides data neeed for test mode operation
********************************************************************************************************************************
*/

/* Includes --------------------------------------------------------------------------------------------------------------------*/
#include "module_application_testing.h"

//#include "driver_gpio.h"

/* Content ---------------------------------------------------------------------------------------------------------------------*/
extern ProcessInfo processInfoTable[];
void AssignModuleMemApplicationTesting(void);

// Global variables specific to this module
uint64_t module_application_testing_poll_time_u64 =0; // Poll time for the module
Application_Testing_Control applicationTestingControl;
...
/**
********************************************************************************************************************************
* @brief   State machine for application testing module
* @details
* @param   drv_identifier_u8, previous_state_u8, next_stat_u8, irq_identfier_u8
* @retval  return_state_u8
********************************************************************************************************************************
*/
uint8_t moduleApplicationTesting_u32(uint8_t drv_identifier_u8, uint8_t previous_state_u8, uint8_t next_state_u8,
                      uint8_t irq_identifier_u8)
{
  ...
  case MEMORY_INIT_MODULE:
    {
      AssignModuleMemApplicationTesting(); // Assign structured memory to Analog 0-10V setting and data 
  ...
  case INIT_MODULE:
    {     
      ...
      module_application_testing_poll_time_u64 = getSysCount() + POLL_TIME; // Store time tick value     
  ...
  case RUN_MODULE:                                                             
    {
      ...
      if (getSysCount() >= module_application_testing_poll_time_u64) // Time above poll time
      {
        module_application_testing_poll_time_u64 = getSysCount() + POLL_TIME; // Next poll time
        // User Code        
      }
      return_state_u8 = RUN_MODULE;
      break;
