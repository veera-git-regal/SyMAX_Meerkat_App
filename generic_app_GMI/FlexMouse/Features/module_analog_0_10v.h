...
{  
  ...
  AnalogVolts_Discretes discretes_u16;// discrete bit indicators
};

typedef struct{
 struct AnalogVolts_Settings analogVolts_Setting ;
 struct AnalogVolts_Data analogVolts_Data;
}AnalogVolts_Control;
